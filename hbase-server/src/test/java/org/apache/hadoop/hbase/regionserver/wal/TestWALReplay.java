...
public class TestWALReplay {
  ...
  static class MockWAL extends FSHLog {
    ...
    public MockWAL(WALFactory wals, FileSystem fs, Path rootDir, String logName, Configuration conf)
        throws IOException {
      super(wals, fs, rootDir, logName, HConstants.HREGION_OLDLOGDIR_NAME, conf, null, true, null, null);
    }
  ...
  private MockWAL createMockWAL() throws IOException {
    MockWAL wal = new MockWAL(wals, fs, hbaseRootDir, logName, conf);
