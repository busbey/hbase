...
public class TestSnapshotFileCache {
  ...
  public void testJustFindLogsDirectory() throws Exception {
    ...
    Path logs = getSnapshotWALsDir(snapshot, "server");
   ...
   */
  public static Path getSnapshotWALsDir(Path snapshotDir, String serverName) {
    return new Path(snapshotDir, AbstractWAL.getWALDirectoryName(serverName));
  }
