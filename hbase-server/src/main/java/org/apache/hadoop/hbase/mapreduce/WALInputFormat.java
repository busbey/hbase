...
public class WALInputFormat extends InputFormat<WALKey, WALEdit> {
   ...
   */
  static class WALRecordReader extends RecordReader<WALKey, WALEdit> {
    private WALProvider.Reader reader = null;
    private WALProvider.Entry currentEntry = new WALProvider.Entry();
    private long startTime;
    private long endTime;
    ...
    public void initialize(InputSplit split, TaskAttemptContext context)
      ...
      try {
        this.reader = WALFactory.createReader(logFile.getFileSystem(conf), 
            logFile, conf);
